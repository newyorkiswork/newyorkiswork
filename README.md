...
- 🚀 **[FortyLaunch CRM](https://github.com/newyorkiswork/fortylaunch)** — operations CRM **built for the FortyLaunch team** to keep deal info, contracts, and call context in one place as they scale. Voice-first **Gemini Live** agent dispatches typed CRM actions across pipeline, contracts/e-sign, calendar, and multi-channel interactions. React 19 + Vite + Supabase. · [Live](https://fortylaunch.vercel.app)
...
I lead a build collective with Pursuit classmates — Sam (backend), Maurice (full-stack), me (UI + frontend) — building for small businesses through the **Brooklyn & Manhattan Chambers of Commerce**. I run client intake, write ERDs/PRDs, and coordinate delivery.

### Reach me

- LinkedIn: [linkedin.com/in/robertpetillo](https://www.linkedin.com/in/robertpetillo/)
- Portfolio: [portfolio-rho-opal-62.vercel.app/portfolio](https://portfolio-rho-opal-62.vercel.app/portfolio) *(work in progress)*
